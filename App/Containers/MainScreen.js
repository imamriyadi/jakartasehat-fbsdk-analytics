...
class MainScreen extends React.Component {
  ...
  KlikAku(pram){
    NavigationActions.fetchlist({ paramKey: pram}),
    AppEventsLogger.logPurchase(15, 'USD', {pram: '10000'})
  }
  ...
  render () {
    ...
    return (
     ...
     <View style={styles.boxButton}>
            ...
            <Button 
              onPress={() => this.KlikAku("puskesmas")}
              style={{
